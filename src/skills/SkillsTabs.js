...
const tabs = [
  {
    label: "Frontend",
    items: [
      { name: "React", desc: "컴포넌트 구조를 이해하고, 훅을 활용하여 동적인 UI를 구현할 수 있습니다." },
      { name: "Next.js", desc: "TypeScript 문법을 준수하며 컴포넌트를 작성하고 컨테이너를 구성할 수 있습니다." },
      { name: "JavaScript", desc: "기본 문법을 이해하고, DOM과 이벤트로 동적인 웹 기능을 구현할 수 있습니다." },
      { name: "TypeScript", desc: "타입을 활용하여 안정적이고 재사용 가능한 코드를 작성할 수 있습니다." },
      { name: "HTML5", desc: "시맨틱 태그로 구조화된 마크업을 작성하고 웹 콘텐츠를 구현할 수 있습니다." },
  ...
  },
  {
    label: "Backend",
    items: [
      { name: "Spring Boot", desc: "Java 기반 웹 프레임워크로 서버 애플리케이션을 개발할 수 있습니다." },
      { name: "JPA/Hibernate", desc: "ORM을 활용하여 데이터베이스와 객체를 효율적으로 매핑할 수 있습니다." },
      { name: "RESTful API", desc: "RESTful API로 클라이언트와 서버 간 데이터 전송이 가능합니다." },
